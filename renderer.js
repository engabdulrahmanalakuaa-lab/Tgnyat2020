...
let userDataPath = ''; // سيتم ملؤه تلقائياً
    ...
    modalContent.innerHTML = `
        ...
        <div class="form-group">
            ...
            <div id="prod-image-preview" style="margin-bottom:5px;">
                ${product.image ? `<img src="file://${userDataPath}/${product.image}" style="max-width:100px; max-height:100px; border:1px solid #ddd; border-radius:4px;">` : ''}
            </div>
